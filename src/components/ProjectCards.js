  ...
  return (
    <>
      ...
      <div
        ...
        <p className="absolute text-sm text-white h-[47%] px-0  py-1 bottom-0 z-20  " style={{ fontFamily: "Raleway, sans-serif"  }}>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 ">
          <div className="relative bg-sky-950 backdrop-blur-xl p-6 sm:p-10  w-[90%] sm:w-[80%] h-auto sm:h-[60%] text-white shadow-2xl border border-white m-5">
            ...
            <h2 className="text-xl sm:text-2xl font-bold mb-3" style={{ fontFamily: "Playfair Display, serif" }}>{title}</h2>
            ...
            <p className="text-base pt-4 mb-3 " style={{ fontFamily: "Georgia, serif"  }}>
              <strong>About:</strong> {about}
            </p>

            <p className="text-base mb-3" style={{ fontFamily: "Georgia, serif"  }}>
            ...
            <p className="text-base mb-6" style={{ fontFamily: "Georgia, serif"  }}>
